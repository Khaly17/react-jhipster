  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="reactJhipsterApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="reactJhipsterApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('reactJhipsterApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('reactJhipsterApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('reactJhipsterApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              />
              <ValidatedField
                label={translate('reactJhipsterApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('reactJhipsterApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('reactJhipsterApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('reactJhipsterApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('reactJhipsterApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('reactJhipsterApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
