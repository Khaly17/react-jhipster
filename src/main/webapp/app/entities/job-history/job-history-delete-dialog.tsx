...
export const JobHistoryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="reactJhipsterApp.jobHistory.delete.question">
        <Translate contentKey="reactJhipsterApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
