...
export const DepartmentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="reactJhipsterApp.department.delete.question">
        <Translate contentKey="reactJhipsterApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
